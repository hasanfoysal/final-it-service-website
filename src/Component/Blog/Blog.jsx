...
<button className="uppercase transition ml-3 duration-300 ease-in-out hover:scale-110 bg-orange-600 shadow-lg  shadow-black text-emerald-50 px-4 mt-7 py-2  rounded-full mx-auto text-center">Employee Spotlight</button>
<img className="w-[150px] h-[150px] my-4 rounded-full ml-3" src={member} alt="" />
<h1 className="text-left font-semibold ml-3">Name: <span className="text-slate-500"> Foysal Hasan</span></h1>
<h1 className="text-left font-semibold ml-3">Position:<span className="text-slate-500">COO</span></h1>
<h1 className="text-left font-semibold ml-3">Date of Joining:<span className="text-slate-500">1 September,2024</span></h1>
<h1 className="text-left font-semibold ml-3">Team:<span className="text-slate-500">Developer</span></h1>
<p className="text-left text-slate-700 ml-3 my-4">In today's spotlight, we introduce Foysal Hasan, who serves as a Front-End developer at LM GROUP. Foysal Hasan is a key member of our Developer Department, and their skills and experience have been instrumental in the successful implementation of our projects.</p>
...
<div>
<h1 className="font-bold text-xl text-left ml-3 pt-3">Daily Responsibilities</h1>
<h2 className="font-light text-lg text-left ml-3">He manages Specific Responsibilities/Projects in their daily work. Their role includes Specific Duties, which are crucial and effective for our team's success.
</h2>
</div>
<div>
<h1 className="font-bold text-xl text-left ml-3">Personal Interests:</h1>
<h2 className="font-light text-lg text-left ml-3">Foysal is not only skilled in their professional field but also passionate about Specific Interest/Hobby in their personal life. Their Various Hobbies/Interests make them a well-rounded and inspiring individual.
</h2>
</div>
<div>
<h1 className="font-bold text-xl text-left ml-3">Quote:</h1>
<h2 className="font-light text-lg text-left ml-3">"He is an invaluable member of our team. Their dedication and professionalism have made a significant contribution to our projects", says Manager.
</h2>
</div>
<div>
<h1 className="font-bold text-xl text-left ml-3">Conclusion:</h1>
<h2 className="font-light text-lg text-left ml-3">We are proud to work with foysal and wish them continued success in the future. Their contributions at LM GROUP continue to strengthen and drive our operations toward greater success.
</h2>
</div>
