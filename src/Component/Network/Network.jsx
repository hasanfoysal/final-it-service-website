...
import img from '../../assets/premium_photo-1683134018612-560033455e43.avif'
...
<div className="hero-content bg-zinc-800 flex-col lg:max-w-[1400px] mx-auto  lg:flex-row-reverse">
    ...
    <div className='lg:mr-20'>
      ...
      <Fade direction='up' delay='o.4'><h1 className="lg:text-5xl text-3xl font-bold">We Offer You Network Administrator!</h1></Fade>
