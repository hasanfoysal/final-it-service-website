...
const About = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div>
      ...
      <div> 
      <LetterPullup className='lg:text-7xl text-4xl pb-4 md:text-4xl  text-white font-bold' words={" About Us "} delay={0.1} />;
...
<div className="card bg-zinc-700 text-white  w-64 md:w-80 transition duration-300 ease-in-out hover:scale-110 mx-auto my-3 lg:w-96 shadow-md">
  <div className="card-body">
  <h2>LM GROUP is a leading technology company established on March 8, 2023, and officially registered in the IT sector on August 22, 2024. We specialize in software development, design, and other technology services. Our mission is to provide innovative solutions that ensure business success and make our customers' lives easier through technology.</h2>
  </div>
</div>
<div className="card bg-zinc-700 text-white  w-64 md:w-80 transition duration-300 ease-in-out hover:scale-110 mx-auto my-3 lg:w-96 shadow-md">
  <div className="card-body">
  <h1>Our experienced team is committed to fulfilling our clients' dreams through cutting-edge technology and expertise. The services we provide include app development, game development, web development, cybersecurity, and much more. LM GROUP's goal is to assist clients in achieving success through the highest quality of technology and to pave the way for our employees' growth.</h1>
  </div>
</div>
<div className="card bg-zinc-700 text-white  w-64 md:w-80 transition duration-300 ease-in-out hover:scale-110 mx-auto my-3 lg:w-96 shadow-md">
  <div className="card-body">
   <h3>We are dedicated to staying aligned with modern technology and exploring new horizons of innovation. We regularly enhance our services and apply new technologies in line with our clients' needs. Our mission is to achieve customer satisfaction and contribute to societal development through technology. We believe that a successful technology project can lead to societal progress, and we are working with all our resources and expertise to make this happen.</h3>
  </div>
</div>
<div className="card  w-64 bg-zinc-700 text-white  md:w-80 transition duration-300 ease-in-out hover:scale-110 mx-auto my-3 lg:w-96 shadow-md">
  <div className="card-body">
   <h3>We constantly strive to improve the quality of our services and to keep pace with new technologies. Our aim is not just technological excellence but also contributing to the creation of a sustainable and advanced society. We have expanded our services across various industries and are always ready to meet our clients' diverse technological needs. At LM GROUP, we believe that technology can make people's lives easier and more prosperous, and we are working towards that goal.

Every project is a new challenge for us, and we embrace each challenge with enthusiasm. We believe that through our work, our clients will achieve success and new technological frontiers will be unveiled.</h3>
  </div>
</div>
</div>
<h3 className="text-3xl text-center pt-12 py-7 font-bold"><span className="text-orange-600 ">**</span> Work Culture <span className="text-orange-600">**</span></h3>
<Fade><h1 className="text-xl text-center px-3 lg:px-64 font-semibold">At LM GROUP, our work culture is the cornerstone of our success. We believe in fostering a collaborative, innovative, and stimulating environment where our employees can fully utilize their creativity and skills. Our work culture is built on the following principles:</h1></Fade>
