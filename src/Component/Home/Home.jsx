...
const Home = () => {
  ...
  <div className="hero-content flex-col lg:flex-row  lg:gap-16 lg:max-w-[1800px] mx-auto">
    <div className="">
...
<BoxReveal boxColor={"#FFA600"} duration={0.5}><Link to='/services'><button className="uppercase transition duration-300 ease-in-out hover:scale-110 bg-orange-600 shadow-md shadow-white text-emerald-50 px-4 mt-2 py-2 rounded-full">explore more</button></Link></BoxReveal>
  ...
  <div className="card-body items-center text-center">
    ...
    <div>
    <BoxReveal boxColor={"#FFA600"} duration={0.5}><Link to='/services'><button className="uppercase transition duration-300 ease-in-out hover:scale-110 bg-orange-600 shadow-md shadow-white text-emerald-50 px-4 mt-2 py-2 rounded-full">More Services</button></Link></BoxReveal></div>
  </div>
</div>
