...
import img from '../../assets/software-developer-6521720_1280.jpg'
...
<div className="hero-content bg-zinc-800 flex-col lg:max-w-[1400px] mx-auto  lg:flex-row-reverse">
    ...
    <div className='lg:mr-20'>
      ...
      <Fade direction='up' delay='o.4'><h1 className="lg:text-5xl text-3xl font-bold">We Offer You Software Development!</h1></Fade>
      <Fade direction='up' delay='o.6'><p className="py-6 ">
      Software development is the process of creating computer programs. It involves planning, designing, coding, testing, and maintaining software applications. Developers use programming languages like Python, Java, and C++ to write code that instructs computers to perform specific tasks. The software development process often follows a structured methodology like Agile or Waterfall to ensure efficient and effective development.  </p></Fade>
